  ...
  , i = function() {
    function i(i, n, s) {
        ...
        this.count = function(t) {
            ...
            a.useEasing ? a.countDown ? a.frameVal = a.startVal - a.easingFn(i, 0, a.startVal - a.endVal, a.duration) : a.frameVal = a.easingFn(i, a.startVal, a.endVal - a.startVal, a.duration) : a.frameVal = a.startVal + (a.endVal - a.startVal) * (i / a.duration);
        ...
        this.formatNumber = function(t) {
            ...
            a.options.useGrouping) {
                ...
                for (var l = 3, h = 0, u = 0, p = n.length; u < p; ++u)
                    a.options.useIndianSeparators && 4 === u && (l = 2,
                    h = 1),
    ...
    return i.prototype.handleScroll = function(t) {
        if (t && window && !t.once) {
            ...
            a < i && a > window.scrollY && t.paused ? (t.paused = !1,
            setTimeout((function() {
                return t.start()
            }
            ), t.options.scrollSpyDelay),
            t.options.scrollSpyOnce && (t.once = !0)) : (window.scrollY > a || s > i) && !t.paused && t.reset()
        }
    }
    ,
    ...
    i.prototype.printValue = function(t) {
        ...
        if (this.el) {
            ...
            if (null === (i = this.options.plugin) || void 0 === i ? void 0 : i.render)
